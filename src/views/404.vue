...
<template>
  <div class="hy-error" style="padding-top:30%;">
    <div class="hy-error-main">
      <div class="hy-error-bg">
        ...
        <div class="hy-error-shadow">
          <img class="animate_shadow" src="../assets//404/404-shadow.png" alt="shadow" />
        </div>
        <div class="hy-error-animate">
          <img class="animate_1" src="../assets//404/404-1.png" alt="1" />
          <img class="animate_2" src="../assets//404/404-2.png" alt="2" />
          <img class="animate_3" src="../assets//404/404-3.png" alt="3" />
          <img class="animate_4" src="../assets//404/404-4.png" alt="4" />
          <img class="animate_5" src="../assets//404/404-5.png" alt="5" /> 
        </div>
      </div>
      <p>你迷路了...别着急，点<a href="/" >这里</a>找到出路</p> 
    </div>
  </div>
</template>
<script>
